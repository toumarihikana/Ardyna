    ...
    public class MovePlayer : MonoBehaviour
    {
        ...
        public void MoveHorizontal(Vector2 direction)
        {
            if (playerStatus.CharacterAnimationStateEnum == CharacterAnimationStateEnum.Waiting)
            {
                ...
                {
                    playerStatus.CharacterAnimationStateEnum = CharacterAnimationStateEnum.Moving;
                }
        ...
        void Update()
        {
            if (playerStatus.CharacterAnimationStateEnum == CharacterAnimationStateEnum.Moving)
            {
